...
const showMeowToast = () => {
    const audio = new Audio('/public/github_sound.mp3');
    audio.play();
};
...
const Navbar = () => {
    ...
    useEffect(() => {
        const fetchStars = async () => {
            try {
                ...
                const res = await fetch("https://api.github.com/repos/your-username/your-repo-name");
    ...
    return (<>
        <nav className='bg-slate-800 fixed top-0 w-full z-100 '>
            <div className="mycontainer flex md:justify-around justify-between items-center px-4 h-14 py-5 text-white md:gap-100 ">
